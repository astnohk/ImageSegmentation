...
IMGCLASS_CFILES = ImgClass/Color.cpp ImgClass/Lab.cpp ImgClass/RGB.cpp ImgClass/HSV.cpp ImgClass/Segmentation.cpp
...
IMGCLASS_OFILES = Color.o Lab.o RGB.o HSV.o Segmentation.o
